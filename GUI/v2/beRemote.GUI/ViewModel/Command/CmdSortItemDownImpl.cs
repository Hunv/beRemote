...
{
    public class CmdSortItemDownImpl : BaseCommand
    {
        public override void Execute(object sender)
        {
            ...
            {
                StorageCore.Core.ModifyConnection(currentItem.ConnectionID, sortIndex, false);
            }
            else if (currentItem.ConnectionType == ConnectionTypeItems.folder)
            {
                StorageCore.Core.ModifyFolderSortOrder(currentItem.ConnectionID, sortIndex, false);
            }
